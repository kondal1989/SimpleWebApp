...
<head>
    <meta charset="UTF-8">
    <title> SARAVANAAAA shopping website</title>
...
<body>
    ...
    <section id="home">
        <header>
   <span style="font-size:64px;margin-right:10px;color:orange">KLMMMMMMMMMMM SHOPPING ZONE</span>
            <ul id="menu">
	...
	<h1><b>welcome to KAVALI kondal jhdasdsaaad </b></h1>   
